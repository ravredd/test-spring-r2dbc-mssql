package com.example.postservice.utils;
...
public class R2DBCURLSplitter {
    ...
    public String toString() {
        return "R2DBCURLSplitter{" + "driverName='" + driverName + '\'' + ", host='" + host + '\'' + ", port=" + port
    ...
    public R2DBCURLSplitter(String r2dbcUrl) {
        ...
        if (r2dbcUrl == null || !r2dbcUrl.startsWith("r2dbc:") || (pos1 = r2dbcUrl.indexOf(':', 6)) == -1)
